if place_empty(x, y, Obj_tower_tower_04_02_menu){
if global.pause_ok == 0{
global.where_my_place = instance_nearest(x, y, Obj_tower_04_02_01);
...
{
	instance_create_layer(x + 0, y + 0, "Instances_img", Obj_tower_tower_04_02_menu);
